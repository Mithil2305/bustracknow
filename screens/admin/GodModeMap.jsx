  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>System-wide control and diagnostics.</Text>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: palette.card, borderRadius: radius.lg, padding: spacing.md, ...shadow.card, gap: 6 },
